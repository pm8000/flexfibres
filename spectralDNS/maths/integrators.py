...
# The variable __all__ is a list of public objects of that module, as interpreted
#  by import *. This variable overrides the default of hiding everything that
# begins with an underscore. In other words, __all__  is a list of strings
#  defining what symbols in a module will be exported when from <module> import *
