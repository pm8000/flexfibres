"""Parameters for the spectralDNSs
...
import argparse     # Module for interfaces, for arguments passed to the program
import collections
import json
...
#   For example, the context are objects of this class
...
parser = argparse.ArgumentParser(prog='spectralDNS', description='Solver for homogeneous isotropic turbulence.', add_help=False)
...
# OBS: I can access an argument as e.g. params.mask_nyquist
...
# Arguments for the fiber dynamics

triplyperiodic.add_argument("--coupled_solver", type=bool, default=False,
                            choices=('True', 'False'),
                            help='Run the coupled solver spectralDNS-FiberSolver (True) or only the solver FiberSolver (False)')
